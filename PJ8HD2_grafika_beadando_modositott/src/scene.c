...
glPopMatrix();	
			...
			glPushMatrix();
    glTranslatef(scene->car.p_position.x, scene->car.p_position.y, scene->car.p_position.z+10);
    glScalef(0.1,0.1,0.1);
    glRotatef(scene->car.p_angle,scene->car.p_rotation.x,scene->car.p_rotation.y,scene->car.p_rotation.z);
